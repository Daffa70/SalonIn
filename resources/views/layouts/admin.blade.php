			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
                        ...
                        <li class="nav-item {{request()->routeIs('admin.listsalon') || request()->routeIs('admin.pendingsalon')  ? 'active' : ''}}">
                            <a href="{{route('admin.listsalon')}}">
                                <i class="fas fa-list"></i>
                                <p>List Salon</p>
                            </a>
                        </li>
						<li class="nav-item {{request()->routeIs('admin.listpembayaran')  ? 'active' : ''}}">
                            <a href="{{route('admin.listpembayaran')}}">

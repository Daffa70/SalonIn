    ...
    <div class="panel-header bg-primary-gradient">
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    <h2 class="text-white pb-2 fw-bold">Pending Salon</h2>
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" href = "{{ route('admin.listsalon') }}" aria-current="page">List Salon</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page">List Salon Pending</a>
                    </li>
                </ul>

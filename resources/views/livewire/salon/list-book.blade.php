            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page">List Booking</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('salon.listallbook') }}">History Order</a>
                        </li>
                    </ul>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-primary" wire:loading.attr="disabled"
                                        wire:click="showModalFinish({{ $booking->id }})" title="Selesai"><i
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <button class="btn btn-primary" wire:click="finish">Ya</button>
                    </div>
                </div>
            </div>
        </div>
